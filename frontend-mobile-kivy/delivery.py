...
class SecondScreen(Screen):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'Payload' in datos:
                    ...
                    detalles_envio = payload.get('detallesEnvio')

                    
                    if isinstance(detalles_envio, str):
                    ...
                    print("Datos del cliente obtenidos con éxito.")
                    print("Nombre:", self.nombre_cliente)
                    print("Dirección:", self.direccion_cliente)
    ...
    def enviar_estado(self, estado):
        id_trackeo = self.ids.input_trackeo.text.strip()
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.mostrar_error(
                    f"Error al actualizar el estado: {response.json().get('mensaje', 'Desconocido')}"
                )
